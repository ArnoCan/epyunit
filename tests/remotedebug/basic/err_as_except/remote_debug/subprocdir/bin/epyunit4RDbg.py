...
if __name__ == '__main__': 
    ...
    # Remote debugging
    #
    from epyunit.debug.checkRDbg import checkAndInitRDbg
    _rdbgthis,_rdbg,_rdbgfwd = checkAndInitRDbg(**{'label':_APPNAME,})
    """
...
class MySubProcessLevel01(object):
    ...
    def execute(self,appname):
        ...
        try:
            ...
            print >>sys.stderr,"ERROR:"+str(err)+" - in:"+__file__
            sys.exit(2)
