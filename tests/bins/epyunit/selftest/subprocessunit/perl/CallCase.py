...
class CallUnits(unittest.TestCase):
    ...
    def testCase020(self):
        ...
        retX = [
            0,
            [
                '#*** epyunit/myscript.pl DEFAULT ***',
                '',
                '#*** epyunit/myscript.pl OK ***',
                '',
                '#*** epyunit/myscript.pl PRIO ***',
                '',
                '#*** epyunit/myscript.pl EXITOK ***',
                '',
                '#*** epyunit/myscript.pl EXITNOK ***',
                '',
                '#*** epyunit/myscript.pl EXIT7 ***',
                '',
                '#*** epyunit/myscript.pl EXIT8 ***',
                '',
                '#*** epyunit/myscript.pl EXIT9OK3NOK2 ***',
                '',
                '#*** epyunit/myscript.pl STDERRONLY ***',
                '',
                '#*** epyunit/myscript.pl DEFAULT ***'
            ],
            []
