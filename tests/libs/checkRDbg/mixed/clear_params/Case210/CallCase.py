...
class CallUnits(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._optstring5 = "python mycall --opt1 --rdbg=host0:1111 --opt2=val1 --opt3 val3 --rdbg-root=/my/root --opt4 --rdbg-sub=sub/a --opt5 --rdbg-forward=2 arg0 arg1 arg2 "
        setDefaults()
    ...
    def testCall050_CheckRdbgStr(self):
        ...
        cr0 = checkRDbg(self._optstring5)
        assert cr0 == True
    ...
    def testCall051_CheckRdbgList(self):
        ...
        lst = shlex.split(self._optstring5)
        cr0 = checkRDbg(lst)
        assert cr0 == True
