...
class CallUnits(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._optstring6 = "python mycall --opt1 --rdbg host0:ssh --opt2=val1 --opt3 val3 --rdbg-root /my/root --opt4 --rdbg-sub sub/a --opt5 --rdbg-forward 2 arg0 arg1 arg2 "
        setDefaults()
    ...
    def testCall050_CheckRdbgStr(self):
        ...
        cr0 = checkRDbg(self._optstring6)
        assert cr0 == True
    ...
    def testCall051_CheckRdbgList(self):
        ...
        lst = shlex.split(self._optstring6)
        cr0 = checkRDbg(lst)
        assert cr0 == True
    ...
    def testCall052_ClearOptionAndValue(self):
        ...
        cr0ref = (True, 'host0:ssh', 1, '/my/root', 'sub/a',)
        assert cr0ref == cr0
