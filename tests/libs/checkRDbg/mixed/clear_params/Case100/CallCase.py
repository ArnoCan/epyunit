...
class CallUnits(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._optstring2 = "python mycall --opt1 --rdbg host0 --opt2=val1 --opt3 val3 --rdbg-root /my/root --opt4 --rdbg-sub sub/a --opt5 --rdbg-forward 2 arg0 arg1 arg2 "
        setDefaults()
    ...
    def testCall020_CheckRdbgStr(self):
        ...
        cr0 = checkRDbg(self._optstring2)
        assert cr0 == True
    ...
    def testCall021_CheckRdbgList(self):
        ...
        lst = shlex.split(self._optstring2)
        cr0 = checkRDbg(lst)
        assert cr0 == True
