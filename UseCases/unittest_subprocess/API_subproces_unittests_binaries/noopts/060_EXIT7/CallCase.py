...
class CallUnits(TestExecutable):
    ...
    def setUp(self):
        ...
        self.call += " EXIT7 "
        self.retX = [7, ['fromF', 'arbitrary output', 'arbitrary signalling NOK string', 'arbitrary output'],[]]
        pass
    ...
    def testCase011(self):
        self.assertSubprocess(
            self.call, 
            [7, ['fromF', 'arbitrary output', 'arbitrary signalling NOK string', 'arbitrary output'],[]]
        )
        pass 
